...
- [[company-intel/instagram-influencer-watch|인스타 인플루언서 관찰]] — 인테리어/감성 분야 인플루언서를 발굴·추적하는 방법과 관찰 기준(분류·점수표·추적 템플릿).
- [[company-intel/ad-media-catalog|광고매체 카탈로그]] — 인스타 외 광고매체의 특징·비용 감각·적합도 비교표.
- [[company-intel/instagram-growth-playbook|인스타 성장 플레이북]] — 도달과 저장을 늘리는 콘텐츠·해시태그·릴스·협업 전략.
...
1. **관찰** — [[company-intel/instagram-influencer-watch|인플루언서 관찰]]로 벤치마크 풀을 만든다.
2. **채널 선택** — [[company-intel/ad-media-catalog|광고매체 카탈로그]]로 어디에 예산을 쓸지 정한다.
3. **실행** — [[company-intel/instagram-growth-playbook|성장 플레이북]]으로 콘텐츠와 협업을 굴린다.
