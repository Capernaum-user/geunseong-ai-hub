...
작업 노트를 평소처럼 쓰기만 하면, 그 상태가 곧 위젯에 반영됩니다. 별도의 대시보드에 다시 입력할 필요가 없습니다. 이 점에서 Peek은 [[obsidian/index|Obsidian × 생성형 AI]] 흐름과 자연스럽게 맞물립니다.
...
- [[agents/ai-agent-roles|AI 에이전트]] — 여러 AI를 역할별로 나눠 돌리는 구조. Peek은 그 작업들을 한눈에 모아 보여준다.
- [[harness/harness-engineering|하네스 엔지니어링]] — 작업 상태·핸드오프를 노트로 관리하는 방법론이 Peek의 데이터 원천이다.
- [[products/channeldock|ChannelDock]] — 같은 "직접 만든 도구" 갈래의 다른 제품.
