...
> **한마디로:** 하네스 **규칙 자체**가 어떻게 바뀌어 왔는지를 지우지 않고 덧붙이기만 하는 기록입니다. 15개로 시작해 17개로 늘었다가, 일관성을 위해 14개로 합쳤습니다.

```mermaid
flowchart LR
    A[2026-05-29<br/>v1 규칙 15개] --> B[2026-05-30<br/>17개로 표준화]
    B --> C[v1.1<br/>14개로 통합]
    C --> D[2026-06-05<br/>Viewer·크기 정책 추가]
```
