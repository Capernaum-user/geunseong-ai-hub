...
> **근성 · AI 지식허브**의 주력 주제 중 하나. 사람이 일일이 손대지 않아도 코드·문서·작업이 굴러가게 만드는 **AI 에이전트**를, 이론이 아니라 실제 운영 기록으로 정리한다.

## 쉽게 말하면

> **한마디로:** AI 에이전트는 "프롬프트 한 번"이 아니라, **스스로 도구를 쓰고 일을 나누고 검증하며 끝까지 처리하는 시스템**입니다.

이 허브는 그런 에이전트를 이론이 아니라 **직접 굴려 본 구조와 규칙**으로 모았습니다. 아래 그림이 전체 지형입니다.
